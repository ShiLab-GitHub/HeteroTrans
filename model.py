...
class PharmHGT(nn.Module):
    def __init__(self,args):
        ...
        # graph view
        self.w_gf = nn.Linear(200,hid_dim)
        self.conv1 = nn.Conv1d(1,1,3,padding=1)
        self.pool1 = nn.MaxPool1d(3,padding=1,stride=1)
        ...
        ## predict
        self.out = nn.Sequential(nn.Linear(5*hid_dim,hid_dim),
                                 self.act,
